...
if("FALSE" STREQUAL "TRUE")
  set(open_karto_SOURCE_PREFIX /tmp/dsc/extract_dir)
  set(open_karto_DEVEL_PREFIX /tmp/dsc/extract_dir/obj-x86_64-linux-gnu/devel)
  ...
  set(open_karto_INSTALL_PREFIX /opt/pal/gallium)
...
if(NOT "include;/usr/include " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'Stephan Wirth <swirth@willowgarage.com>, Procopio Stein <procopio.stein@pal-robotics.com>' and request to fix the problem.")
  endif()
...
set(libraries "OpenKarto;/usr/lib/x86_64-linux-gnu/libboost_system.so.1.71.0")
...
set(depends "backward_ros;geometry_msgs;nav_msgs;roscpp;sensor_msgs;tf")
