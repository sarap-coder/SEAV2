...
(cl:defmethod cl:initialize-instance :after ((m <StartupStatus>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'StartupStatus)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pal_supervisor_msgs-msg:<StartupStatus> is deprecated: use pal_supervisor_msgs-msg:StartupStatus instead.")))
...
(cl:defmethod message-val ((m <StartupStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pal_supervisor_msgs-msg:message-val is deprecated.  Use pal_supervisor_msgs-msg:message instead.")
  (message m))

(cl:ensure-generic-function 'status-val :lambda-list '(m))
(cl:defmethod status-val ((m <StartupStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pal_supervisor_msgs-msg:status-val is deprecated.  Use pal_supervisor_msgs-msg:status instead.")
  (status m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<StartupStatus>)))
  ...
  "pal_supervisor_msgs/StartupStatus")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'StartupStatus)))
  "Returns string type for a message object of type 'StartupStatus"
  "pal_supervisor_msgs/StartupStatus")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<StartupStatus>)))
  ...
  "6c21656eb2da6dbc6c6eca6aff588168")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'StartupStatus)))
  "Returns md5sum for a message object of type 'StartupStatus"
  "6c21656eb2da6dbc6c6eca6aff588168")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<StartupStatus>)))
  ...
  (cl:format cl:nil "string name # application name~%string message # description of the status if required~%# Possible status of startup process~%byte RUNNING=0~%byte WAITING=1~%byte TIMEOUT=2~%byte ABORTED=3 #Application not running~%byte status # status of the startup process for the application. Enumerated above ~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'StartupStatus)))
  "Returns full string definition for message of type 'StartupStatus"
  (cl:format cl:nil "string name # application name~%string message # description of the status if required~%# Possible status of startup process~%byte RUNNING=0~%byte WAITING=1~%byte TIMEOUT=2~%byte ABORTED=3 #Application not running~%byte status # status of the startup process for the application. Enumerated above ~%~%~%~%"))
