...
(cl:defmethod cl:initialize-instance :after ((m <lookupTransform-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'lookupTransform-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pal_supervisor_msgs-srv:<lookupTransform-request> is deprecated: use pal_supervisor_msgs-srv:lookupTransform-request instead.")))

(cl:ensure-generic-function 'target_frame-val :lambda-list '(m))
(cl:defmethod target_frame-val ((m <lookupTransform-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pal_supervisor_msgs-srv:target_frame-val is deprecated.  Use pal_supervisor_msgs-srv:target_frame instead.")
  (target_frame m))

(cl:ensure-generic-function 'source_frame-val :lambda-list '(m))
(cl:defmethod source_frame-val ((m <lookupTransform-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pal_supervisor_msgs-srv:source_frame-val is deprecated.  Use pal_supervisor_msgs-srv:source_frame instead.")
  (source_frame m))

(cl:ensure-generic-function 'transform_time-val :lambda-list '(m))
(cl:defmethod transform_time-val ((m <lookupTransform-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pal_supervisor_msgs-srv:transform_time-val is deprecated.  Use pal_supervisor_msgs-srv:transform_time instead.")
  (transform_time m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<lookupTransform-request>)))
  ...
  "pal_supervisor_msgs/lookupTransformRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'lookupTransform-request)))
  "Returns string type for a service object of type 'lookupTransform-request"
  "pal_supervisor_msgs/lookupTransformRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <lookupTransform-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'lookupTransform-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pal_supervisor_msgs-srv:<lookupTransform-response> is deprecated: use pal_supervisor_msgs-srv:lookupTransform-response instead.")))

(cl:ensure-generic-function 'transform-val :lambda-list '(m))
(cl:defmethod transform-val ((m <lookupTransform-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pal_supervisor_msgs-srv:transform-val is deprecated.  Use pal_supervisor_msgs-srv:transform instead.")
  (transform m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<lookupTransform-response>)))
  ...
  "pal_supervisor_msgs/lookupTransformResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'lookupTransform-response)))
  "Returns string type for a service object of type 'lookupTransform-response"
  "pal_supervisor_msgs/lookupTransformResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'lookupTransform)))
  ...
  "pal_supervisor_msgs/lookupTransform")