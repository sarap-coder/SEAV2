  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.nodes:
        ...
        _x = val1
        buff.write(_get_struct_5dB().pack(_x.fx, _x.fy, _x.cx, _x.cy, _x.baseline, _x.fixed))
      length = len(self.points)
      buff.write(_struct_I.pack(length))
      for val1 in self.points:
        _x = val1
        buff.write(_get_struct_I4d().pack(_x.index, _x.x, _x.y, _x.z, _x.w))
      length = len(self.projections)
      buff.write(_struct_I.pack(length))
      for val1 in self.projections:
        _x = val1
        buff.write(_get_struct_2I3d2B().pack(_x.camindex, _x.pointindex, _x.u, _x.v, _x.d, _x.stereo, _x.usecovariance))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        (_x.fx, _x.fy, _x.cx, _x.cy, _x.baseline, _x.fixed,) = _get_struct_5dB().unpack(str[start:end])
      ...
      for i in range(0, length):
        ...
        (_x.index, _x.x, _x.y, _x.z, _x.w,) = _get_struct_I4d().unpack(str[start:end])
      ...
      for i in range(0, length):
        ...
        (_x.camindex, _x.pointindex, _x.u, _x.v, _x.d, _x.stereo, _x.usecovariance,) = _get_struct_2I3d2B().unpack(str[start:end])
