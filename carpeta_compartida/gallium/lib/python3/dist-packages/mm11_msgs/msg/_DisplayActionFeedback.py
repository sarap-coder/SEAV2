...
"""autogenerated by genpy from mm11_msgs/DisplayActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class DisplayActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "mm11_msgs/DisplayActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','mm11_msgs/DisplayFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(DisplayActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = mm11_msgs.msg.DisplayFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = mm11_msgs.msg.DisplayFeedback()
