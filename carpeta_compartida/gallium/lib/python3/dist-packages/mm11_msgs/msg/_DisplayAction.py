...
"""autogenerated by genpy from mm11_msgs/DisplayAction.msg. Do not edit."""
import codecs
import sys
...
class DisplayAction(genpy.Message):
  _md5sum = "2a569a1e947279284676f5e8f66c20ff"
  _type = "mm11_msgs/DisplayAction"
...
"""
  ...
  _slot_types = ['mm11_msgs/DisplayActionGoal','mm11_msgs/DisplayActionResult','mm11_msgs/DisplayActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(DisplayAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = mm11_msgs.msg.DisplayActionGoal()
      if self.action_result is None:
        self.action_result = mm11_msgs.msg.DisplayActionResult()
      if self.action_feedback is None:
        self.action_feedback = mm11_msgs.msg.DisplayActionFeedback()
    else:
      self.action_goal = mm11_msgs.msg.DisplayActionGoal()
      self.action_result = mm11_msgs.msg.DisplayActionResult()
      self.action_feedback = mm11_msgs.msg.DisplayActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.action_goal.goal.screen_type
      buff.write(_get_struct_B().pack(_x))
      length = len(self.action_goal.goal.entries)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_goal.goal.entries:
        _x = val1.type
        buff.write(_get_struct_B().pack(_x))
        _x = val1.text
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.action_goal.goal.screen_type,) = _get_struct_B().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.action_goal.goal.entries = []
      for i in range(0, length):
        ...
        self.action_goal.goal.entries.append(val1)
      _x = self
      start = end
      end += 12
